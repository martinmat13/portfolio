...
![control loop](./images/thesis/control_Loop.png)*Figure: Control Loop*
![unsteady flow](./images/thesis/unsteady_flow.png)*Figure: Simulink Modelling for Hydrofoil Control System in UnSteady Flow Conditions*
